...
<head>
    ...
    <link rel="icon" type="image/gif" href="{{asset('Images/wave.gif',true)}}">
    <title>{{ config('app.name', 'Laravel') }}</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.1/font/bootstrap-icons.css">
    <link rel="stylesheet" href="{{asset('css/custom.css',true)}}" class="stylesheet">
            ...
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
              ...
              <div class="song-small m-2 ms-4 col-md-6 row align-items-center">
                ...
                <div class="col d-flex">
                    <img class="song-small-img rounded m-1" src="{{asset('Images/apple-music.svg',true)}}" alt="Album Art"/>
                    <div class="ms-1 pt-3">
                       <div>
                ...
                <div class="col-2">
                    <i class="bi bi-play-circle play-btn" data-src="{{asset('upload/Metro-Boomin-Superhero-Heroes--Villains.mp3',true)}}"></i>
                </div>
                <div class="audio-controls" style = "display:none">
                    <audio class="audio-player" controls onloadedmetadata="setAudioDuration(this)">
                        <source src="{{asset('upload/Metro-Boomin-Superhero-Heroes--Villains.mp3',true)}}" type="audio/mp3">
