    ...
    <main>
        ...
        <div class="heroarea text-white p-2">
            <ul class=" hero-nav nav nav-pills ms-2 mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="text-white nav-link" id="pills--tab" data-bs-toggle="pill" data-bs-target="#pills-" type="button" role="tab" aria-controls="pills-" aria-selected="false">Trending</button>
                </li>
